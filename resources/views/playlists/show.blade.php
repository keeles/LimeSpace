    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <button class="border border-gray-100 rounded-sm px-2">
                            <a href="{{ route('playlists.edit', $playlist->id) }}" class="text-blue-500 hover:underline">Edit</a>
                        </button>
                        <button class="border border-gray-100 rounded-sm px-2">
            ...
            <div class="p-4 mt-2">
                <ul>
                    ...
                    <li class="px-4 py-2 border-b border-gray-700 dark:border-gray-600">
                        <div class="song-item flex justify-between items-center">
                            <div>
            ...
            <div class="mt-4 flex justify-between">
                <a href="{{ url()->previous() }}" class="dark:text-gray-100 hover:underline">Back</a>
                ...
                <form method="POST" action="{{ route('playlists.destroy', $playlist->id) }}" onsubmit="return confirm('Are you sure you want to delete this playlist?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="dark:text-gray-100 hover:text-red-700">Delete Playlist</button>
                </form>
                @endif
            </div>
        </div>
